...
pred_path = "2215/2007-12-13_10-02-08/im1_predict.png"
gt_path = pred_path.replace("_predict.png", "_sn.npy")
...
np_pred = cv2.imread(str(os.path.join(pred_dir, pred_path)))
np_pred = cv2.cvtColor(np_pred, cv2.COLOR_BGR2RGB)
...
axes[2].imshow((np_pred).astype(np.uint8))
